        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HeadLogo = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    ...
                    UnionId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    SessionKey = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ...
                    WechatH5RefreshToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WechatH5RefreshTokenExpiredIn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
